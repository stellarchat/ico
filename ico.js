	...
	"ongoing" : [
     {
        ...
        "p1": "The next generation global self-financing blockchain protocol. Credit Circulation, Asset Circulation and Value Circulation.",
        "p1_cn": "新一代全球自金融区块链协议。信用流通，资产流通，价值流通。在中国企业自金融领域已落地多个大中型企业。",
        "p2": "The ULT token service on Stellar is provided by foxtrex.com",
        "p2_cn": "恒星上的ULT Token由foxtrex.com提供服务。"
     },
     {
				"name" : "Mobius",
				"name_cn" : "Mobius",
			...
			{
        "name" : "U919",
        "name_cn" : "Ultiledger纪念酒",
        "website" : "",
        "code" : "U919",
        "issuer" : "GDHISJW5E75ISBJOMCARPSIHXRBCEMP3LHTKZ755BEYSFAQXIBXHQIAN",
        "p1" : "Bring the traditional wine culture to the blockchain.",
        ...
        "p1" : "XYG was originally designed to encourage developers to integrate blockchain technology with existing legacy application products and development processes.",
        "p1_cn" : "小鱼干用于鼓励开发者将区块链技术与现有的传统应用产品以及开发过程进行融合。",
